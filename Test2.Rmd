...
As our sample size gets larger and larger, we tend to see the sample means getting closer to the mean of the original distribution. With resampling, all resample means approach the distribution's mean. 
